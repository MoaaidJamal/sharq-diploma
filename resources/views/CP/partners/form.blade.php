            ...
            <div class="modal-body">
                <div class="row">
                    <div class="form-group col-12">
                        <div class="row">
                            <label class="col-12" for="url">@lang($module.'.url') <span class="text-danger">*</span></label>
                            <div class="col-12">
                                <input type="url" name="url" id="url" class="form-control" placeholder="@lang($module.'.url')" @if($record) value="{{$record->url}}" @endif>
                            </div>
                            <div class="col-12 text-danger" id="url_error"></div>
                        </div>
                    </div>
