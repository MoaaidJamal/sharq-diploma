                            ...
                            <div class="card-body">
                                    ...
                                    <div class="card card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12 form-group">
                                                <div class="row">
                                                    <label class="col-md-12" for="title">@lang($module.'.category_title')</label>
                                                    <div class="col-md-12">
                                                        <input type="text" class="form-control" name="title" id="title" placeholder="@lang($module.'.category_title')">
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <table class="table" id="items_table">
                                    ...
                                    <tr>
                                        ...
                                        <th>@lang($module.'.category_title')</th>
