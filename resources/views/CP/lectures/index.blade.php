                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    <a href="{{ route($parent_module.'.'.$module.'.show_form', ['course_id' => $parent->id])}}" type="button" class="btn btn-primary" id="add_edit_btn">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table" id="items_table">
                                    ...
                                    <tr>
                                        ...
                                        <th>@lang($module.'.category_id')</th>
                                        <th>@lang($module.'.lectures_group')</th>
        ...
        $(function () {
            let datatable = $('#items_table').DataTable({
                ...
                columns: [
                    ...
                    {className: 'text-center cursor-pointer', data: 'category_id', name: 'category_id'},
                    {className: 'text-center cursor-pointer', data: 'lectures_group', name: 'lectures_group'},
            ...
            datatable.on('row-reorder', function (e, details) {
                if(details.length) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route($parent_module.'.'.$module.'.reorder') }}",
                        data: { rows }
                    }).done(function () {
                        $('#items_table').DataTable().ajax.reload(null, false);
                        KTApp.unblockPage();
