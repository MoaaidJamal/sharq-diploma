                                ...
                                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up main">
                                    <div class="navi navi-hover scroll my-4 ps ps--active-y" data-scroll="true">
                                        @foreach($phases as $phase)
                                            <a href="{{url()->current()}}?set_main_phase={{$phase->id}}" class="navi-item">
                                                <div class="navi-link @if(session('dashboard_phase_id') == $phase->id) active @endif">
                                                    <div class="navi-text">
                                                        <div class="font-weight-bold">{{$phase->title}}</div>
                                                    </div>
                                                </div>
                                            </a>
                                        @endforeach
